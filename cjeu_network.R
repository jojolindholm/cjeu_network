...
# MAIN LOOP
  ...
  write_graph(g, "output/cjeu_network.gml", format = "graphml")
  ftpUpload("output/cjeu_network.gml", 
            "ftp://courtdata.se:Bondeska@linux166.unoeuro.com/public_html/cjeu_data/cjeu_network.gml")
  
  df <- createVertexDf(g)
  write_csv(df, "output/cjeu_centrality.csv")
  ftpUpload("output/cjeu_centrality.csv", 
            "ftp://courtdata.se:Bondeska@linux166.unoeuro.com/public_html/cjeu_data/cjeu_centrality.csv")